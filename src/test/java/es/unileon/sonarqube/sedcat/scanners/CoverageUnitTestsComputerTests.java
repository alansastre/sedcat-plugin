...
public class CoverageUnitTestsComputerTests {
	...
	/**
	 * Test method for
	 * {@link es.unileon.sonarqube.sedcat.scanners.CoverageUnitTestsComputer#define(org.sonar.api.ce.measure.MeasureComputer.MeasureComputerDefinitionContext)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link es.unileon.sonarqube.sedcat.scanners.CoverageUnitTestsComputer#compute(org.sonar.api.ce.measure.MeasureComputer.MeasureComputerContext)}
	 * .
	 */
	@Test
	public final void testcompute_notNull_Measure() {
		...
		Mockito.verify(computerContextMocked, times(1)).addMeasure(SedcatMetricsKeys.COVERAGE_UNIT_TESTS_KEY,
