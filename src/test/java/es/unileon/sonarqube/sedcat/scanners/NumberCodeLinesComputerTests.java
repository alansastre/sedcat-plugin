...
public class NumberCodeLinesComputerTests {
	...
	/**
	 * Test method for
	 * {@link es.unileon.sonarqube.sedcat.scanners.NumberCodeLinesComputer#define(org.sonar.api.ce.measure.MeasureComputer.MeasureComputerDefinitionContext)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link es.unileon.sonarqube.sedcat.scanners.NumberCodeLinesComputer#compute(org.sonar.api.ce.measure.MeasureComputer.MeasureComputerContext)}
	 * .
	 */
	@Test
	public final void testcompute_notNull_Measure_File() {
		...
		Mockito.verify(computerContextMocked, times(1)).addMeasure(SedcatMetricsKeys.CODE_LINES_KEY,
				measureMocked.getIntValue());
