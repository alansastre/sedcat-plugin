...
public class TP_Calidad_Mutantes {
 private double min = 0.0;
 private double max = 100.0;
 private double step = 1.0;
 double _ps_muybajo[] = { -12.5,0.0,5.0,10.01 };
 double _pl_muybajo[] = {  };
 double _ps_bajo[] = { 10.01,15.0,25.0,35.01 };
 double _pl_bajo[] = {  };
 double _ps_medio[] = { 35.01,40.0,45.0,55.01 };
 double _pl_medio[] = {  };
 double _ps_medioAlto[] = { 55.01,57.0,63.0,75.01 };
